  ...
  try {
    ...
    const chat = await genAI.models.generateContentStream({
      ...
      config: {
        ...
        "- NEWS: You can summarize news if asked. Use your search tool to find the most recent headlines from trusted sources like Khovar (National Information Agency), Asia-Plus, Radio Ozodi (RFE/RL), BBC Tajik, Avesta.tj, Sputnik Tajikistan, and regional news from Central Asia, Iran, and Afghanistan.\n\n" +
        "ISLAMIC CONTEXT:\n" +
